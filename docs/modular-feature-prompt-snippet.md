# Modular Feature Prompt Snippet

Paste this into future feature chats before implementation work:
...
Use the snippet whenever a new feature might otherwise be added to the nearest visible file instead of the correct functional module.
